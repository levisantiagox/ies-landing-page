...
(function () {
  ...
  // ============================================
  // 7. Form Submission — GHL API (direct)
  // Worker proxy deferred until post-workshop — token lives in public
  // git history anyway, rotate in GHL + redeploy via worker when ready.
  // ============================================
